...
AVAILABLE_SEMANTIC_MODELS_PATHS = [
    "TOG_WORKSHOP.POLICE.FILE_STAGE/call_for_service_semantics.yaml"
]
...
def show_header_and_sidebar():
    ...
    st.image("https://www.gilbertedi.com/wp-content/uploads/2021/03/Gilbert_Logo-Lockup_Arizona_DarkBlue_Final-01.png")
    st.title("Cortex Analyst for Gilbert Police Calls for Service :cactus:")
    st.markdown(
